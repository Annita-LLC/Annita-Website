  ...
  const TimeUnit = ({ value, label }: { value: number; label: string }) => (
    <div className="flex flex-col items-center">
      <div className="relative">
        <div className="bg-gradient-to-br from-blue-600 to-purple-600 text-white rounded-2xl p-3 sm:p-4 lg:p-6 min-w-[60px] sm:min-w-[80px] lg:min-w-[100px] shadow-lg">
          <span className="text-2xl sm:text-3xl lg:text-4xl font-bold tabular-nums">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center items-center mb-12 sm:mb-16">
          <div className="flex items-center space-x-2 sm:space-x-4 lg:space-x-6">
            ...
            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-400 dark:text-gray-600">:</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
