        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We're looking for talented individuals to join our mission. Explore our current openings and find your perfect role.
              </p>
            </div>
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                  <div className="lg:w-1/4">
                    ...
                    <div className="flex items-center text-sm text-gray-600 mb-4">
                      ...
                      Full-time • Remote / Liberia
                    </div>
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">React</span>
                      <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">TypeScript</span>
                      <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">Next.js</span>
                    </div>
                  </div>
                  ...
                  <div className="lg:w-3/4">
                    <div className="grid md:grid-cols-2 gap-8">
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-4">About the Role</h4>
                        <p className="text-gray-600 mb-4 leading-relaxed">
                          We're looking for a passionate Frontend Developer to join our engineering team. You'll be responsible for building beautiful, responsive, and performant user interfaces for our digital ecosystem that serves millions of African users.
                        </p>
                        <h4 className="text-lg font-semibold text-gray-900 mb-4">What You'll Do</h4>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2 text-gray-600 mb-4">
                          ...
                          <li className="flex items-start">
                            ...
                            <strong>Bachelor's degree is optional</strong> - we value skills and experience
                          </li>
                        </ul>
                        <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                          <p className="text-sm text-orange-800">
                            <strong>Salary:</strong> Disclosed after successful completion of first interview phase
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 text-center">
                      <button className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
              ...
              >
                <div className="flex flex-col lg:flex-row gap-8">
                  <div className="lg:w-1/4">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">Docker</span>
                      <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">AWS</span>
                      <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">Kubernetes</span>
                    </div>
                  </div>
                  ...
                  <div className="lg:w-3/4">
                    <div className="grid md:grid-cols-2 gap-8">
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900 mb-4">About the Role</h4>
                        <p className="text-gray-600 mb-4 leading-relaxed">
                          We're seeking a skilled DevOps Engineer to build and maintain our cloud infrastructure. You'll ensure our digital ecosystem runs reliably, securely, and at scale as we serve millions of users across Africa.
                        </p>
                        <h4 className="text-lg font-semibold text-gray-900 mb-4">What You'll Do</h4>
                        <ul className="space-y-2 text-gray-600">
                          <li className="flex items-start">
                            ...
                            Design, build, and maintain cloud infrastructure on AWS and Railway
                          </li>
                          <li className="flex items-start">
                            <svg className="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    ...
                    <div className="mt-6 text-center">
                      <button className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-700">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-4">Get notified about future opportunities</h3>
