...
import { User, Clock, ArrowLeft, LogOut } from 'lucide-react'
...
export default function EmployeeWorkTrackerPage() {
  ...
  return (
    <>
      <SEOHead
        title="Work Tracker - Annita"
        description="Employee work tracking and time management system"
        keywords={['work tracker', 'time management', 'employee productivity', 'tasks']}
        noIndex={true}
        noFollow={true}
      />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  <h1 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 truncate">Work Tracker</h1>
                  {employeeId && (
